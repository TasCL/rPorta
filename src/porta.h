...
// [MG]: Very quick and dirty method to prevent clang 6.1 (and above?) on OS X machines from (probably validly) complaining about abs misuse
#pragma clang diagnostic ignored "-Wabsolute-value"

// [MG]: Enable/disable logging
...
FILE *fp;//  ,*prt; [MG]: DISABLED FOR R VERSION
char * RATallo();
char * allo();
